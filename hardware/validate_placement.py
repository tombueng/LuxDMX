...
ASSOC = [
    ...
    ("D1","J1","DMX_AO","DMX1 TVS near XLR",10), ("D7","J5","DMX2_AO","DMX2 TVS near XLR",10),
    # NB: L2/L3 (CM chokes) + FB2/FB3 (ferrites) are series filter elements placed cable-side / between
    # bulk and driver by DESIGN, not HF-decoupling caps, so they are intentionally NOT proximity-checked.
]
