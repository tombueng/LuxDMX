...
SECTIONS = [
    ...
    ("USB-C (J2)  +  ESD (U8)  ->  S3 native USB (USB-Serial-JTAG on IO19/IO20)",
     ["J2", "U8", "R8", "R9", "F1"]),
    ("PoE PD (U7)  +  5V priority mux (U9 TPS2116, PoE preferred)",
     ["U7", "U9", "D10", "D11", "C27", "C28", "C29", "C30", "C31", "FB1", "R24", "R25"]),
