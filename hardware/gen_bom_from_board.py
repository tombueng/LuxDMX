...
INFO = {
    ...
    "R14": ("150R 0402", "C2909321"), "R16": ("150R 0402", "C2909321"),
    "R17": ("150R 0402", "C2909321"),
    "R18": ("49.9R 1% 0402 W5500 TX center-tap bias", "C25120"),   # BASIC (UNI-ROYAL 0402WGF499, 1%) - no fee
    "R4": ("330R 0402", "C2930002"), "R5": ("330R 0402", "C2930002"),
    ...
    "R20": ("470R 0402 (DMX-A fail-safe bias)", "C2909361"), "R21": ("470R 0402 (DMX-B fail-safe bias)", "C2909361"),
    "R22": ("470R 0402 (DMX2-A fail-safe bias)", "C2909361"), "R23": ("470R 0402 (DMX2-B fail-safe bias)", "C2909361"),
    ...
    "FB1": ("600R@100MHz ferrite bead 0805 (+5V to DMX DC-DC)", "C1017"),
    "FB2": ("600R@100MHz ferrite bead 0805 (VISO driver)", "C1017"),
    "FB3": ("600R@100MHz ferrite bead 0805 (VISO2 driver)", "C1017"),
