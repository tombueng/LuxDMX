# LuxDMX v6.0 — Hardware Validation Tracking
...
## 2026-07-19 — v6.0: J4/J6 mis-plug fix (breaking pinout change)

**Why the MAJOR bump:** J6's pinout changed incompatibly, so a v5.2 expansion cable does not fit a v6.0
